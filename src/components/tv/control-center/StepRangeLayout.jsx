 ...
 * onChange feeds TvRemotePanel's draft, committed only by its Save button.
 */
export default function StepRangeLayout({ config, settings, onChange }) {
  ...
  return (
    <div>
      ...
      <div style={{ fontFamily: inter, fontSize: 13, color: P.mute, marginBottom: sp[5], lineHeight: 1.5 }}>
        ...
        Nothing here goes live until you press Save.
      </div>

      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: sp[3], marginBottom: sp[4] }}>
