...
-- is_ball_dress(), is_ball_attire(), is_rifle_admin()), so there is no new
-- authorization surface here, no new source of truth, and no way for this
-- hub to disagree with the portal it links to.
-- ============================================================================
...
language sql stable security definer set search_path = public as $$
  ...
  union all
  select 'rifle_portal', 'Rifle Team Admin',
         'Manage the rifle team roster', '/rifle/portal'
  where public.is_rifle_admin();
$$;
