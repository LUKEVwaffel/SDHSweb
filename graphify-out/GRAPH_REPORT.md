...
## Corpus Check
- 429 files · ~718,019 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2295 nodes · 4620 edges · 291 communities (170 shown, 121 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7bd9590a`
...
- `StepPhotoSource()` --indirect_call--> `uploadTvDailyPhoto()`  [INFERRED]
  src/components/tv/control-center/StepPhotoSource.jsx → src/lib/tvDailyPhotos.js
...
## Communities (291 total, 121 thin omitted)
...
Cohesion: 0.13
Nodes (17): Dashboard(), Admin(), AccountAuth(), EyeIcon(), PasswordForm(), LoginScreen(), ALLOWED_MIME, Composer() (+9 more)

### Community 27 - "TabPlaceholder.jsx"
Cohesion: 0.21
Nodes (11): AnnouncementSingleEditor(), RenderRuns(), storageStringToRuns(), SlideAnnouncements(), SlideAnnouncementSingle(), formatEventDate(), SlideEventSpotlight(), NoticeRow() (+3 more)

### Community 41 - "PhotoUploader.jsx"
Cohesion: 0.07
Nodes (28): ROLE_SECTIONS, SECTION_LABEL, NAV_GROUPS, ROLE_TAG, Sidebar(), AdvancedPanel(), BetaFeaturesPanel(), CheckinPanel() (+20 more)
...
Cohesion: 0.10
Nodes (19): AccountGrid(), ForcePasswordChange(), inputStyle(), StatusBar(), TopBar(), SelfCredentialControls(), FocalPointPicker(), Modal() (+11 more)

### Community 44 - "imageResize.js"
Cohesion: 0.06
Nodes (32): draftFromSettings(), PER_ACTION_TABS, rangeConfigFromRow(), rangePhaseLabel(), SCREENS, TvRemotePanel(), SlidePhotoOfDay(), isStale() (+24 more)
...
Cohesion: 0.07
Nodes (32): EmergencyPushPanel(), TEXT_SIZES, ROW, TabIntro(), TvRemoteGuide(), GUIDE_SECTIONS, TAB_INTRO, WALKTHROUGH (+24 more)
...
Cohesion: 0.23
Nodes (14): ExistingEntry(), NewEntryForm(), domToRuns(), mergeRuns(), runsToPlainText(), runsToStorageString(), sameFormat(), stringToRuns() (+6 more)
...
Cohesion: 0.17
Nodes (19): BallDressStaffTab(), BallPanel(), emptyApprover(), miniBtn, TABS, BlockFields(), EmailBuilder(), Messages() (+11 more)
...
Cohesion: 0.12
Nodes (12): App(), TABS, BallLanding(), fmtDate(), BallDressLogin(), BallDressPortal(), HomeNewsletterBand(), P (+4 more)
...
Cohesion: 0.24
Nodes (9): SlideUniformCountdown(), targetDate(), uniformDateLabel(), TvRangeRotationLayout(), todayNy(), useTvNextUniformDay(), useTvNotices(), todayNy() (+1 more)
...
Cohesion: 0.20
Nodes (9): isStandalone(), Rhea(), RheaApp(), RheaLocked(), WALK_STEPS, useRheaGate(), hasOnboardedRhea(), hasWalkthroughRhea() (+1 more)
...
Cohesion: 0.11
Nodes (33): TvRangeCompanyWelcomeScreen(), TvRangeCountdown(), TvRangeLunchScreen(), TvRangeOffHoursScreen(), TvRangePeriodEndingScreen(), TvRangePeriodProgressBar(), TvRangePlanningScreen(), TvRangeScreenBase() (+25 more)
...
### Community 287 - "TvRangeRaiderPracticeWidget.jsx"
Cohesion: 0.32
...
## Knowledge Gaps
- **711 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+706 more)
...
- **Why does `react` connect `react` to `PhotoUploader.jsx`, `EventsPanel.jsx`, `getDeviceId`, `BattalionCommand.jsx`, `EventFeedbackForm.jsx`, `RaiderPolls.jsx`, `CheckinSurvey.jsx`, `Raiders.jsx`, `RaiderCompetitionResults.jsx`, `blocks.js`, `About.jsx`, `TvClockBellPanel.jsx`, `.oxlintrc.json`, `Messages.jsx`, `emailRender.js`, `CadetManual.jsx`, `Footer.jsx`, `Companies.jsx`, `RaiderFAQ.jsx`, `FaqSection.jsx`, `TabPlaceholder.jsx`, `TvTopStrip.jsx`, `TvRangeRaiderPracticeWidget.jsx`, `TvTopStrip.jsx`, `Companies.jsx`, `RaiderCarousel.jsx`, `PhotoUploader.jsx`, `Rifle.jsx`, `imageResize.js`, `App.jsx`, `expo-application`, `RaiderVoting.jsx`, `AarsPanel.jsx`, `emailRender.js`, `RaiderCarousel.jsx`, `ui.jsx`, `imageResize.js`, `TvRemotePanel.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `PhotoLightbox.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `MonthGridCalendar.jsx`, `ConversationList.jsx`, `eventsPdfPrint.js`, `TvRangeSlideshowScreen.jsx`, `RaiderCarousel.jsx`, `TvRangeRaiderPracticeWidget.jsx`, `FaqSection.jsx`, `TvRangeKiosk.jsx`, `TvPhotoCarousel.jsx`, `EventSpotlightBand.jsx`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `P` connect `Rifle.jsx` to `react`, `PhotoUploader.jsx`, `EventsPanel.jsx`, `RaiderPolls.jsx`, `emailRender.js`, `blocks.js`, `StepRangeSchedule.jsx`, `tvRangeSchedule.js`, `Messages.jsx`, `RaiderParentWelcome.jsx`, `FaqSection.jsx`, `TabPlaceholder.jsx`, `TvTopStrip.jsx`, `TvRangeRaiderPracticeWidget.jsx`, `TvTopStrip.jsx`, `PhotoUploader.jsx`, `imageResize.js`, `RaiderVoting.jsx`, `AarsPanel.jsx`, `RaiderCarousel.jsx`, `TvRemotePanel.jsx`, `RaiderPolls.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `ConversationList.jsx`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `supabase` connect `FaqSection.jsx` to `react`, `EventsPanel.jsx`, `getDeviceId`, `BattalionCommand.jsx`, `Raiders.jsx`, `RaiderPolls.jsx`, `CheckinSurvey.jsx`, `App.jsx`, `blocks.js`, `About.jsx`, `Messages.jsx`, `Footer.jsx`, `Companies.jsx`, `TvTopStrip.jsx`, `TvTopStrip.jsx`, `Companies.jsx`, `PhotoUploader.jsx`, `Rifle.jsx`, `imageResize.js`, `expo-file-system`, `RaiderVoting.jsx`, `AarsPanel.jsx`, `emailRender.js`, `RaiderCarousel.jsx`, `ui.jsx`, `TvRemotePanel.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `OverviewPanel.jsx`, `ConversationList.jsx`, `TvRangeSlideshowScreen.jsx`, `FaqSection.jsx`, `TvPhotoCarousel.jsx`, `EventSpotlightBand.jsx`?**
