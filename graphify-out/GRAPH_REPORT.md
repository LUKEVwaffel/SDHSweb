...
## Corpus Check
- 191 files · ~510,049 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1340 nodes · 2251 edges · 197 communities (105 shown, 92 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0df5b6c5`
...
### Community 0 - "react"
Cohesion: 0.11
Nodes (18): AchievementCatalog(), ICON_MIME, SUBTABS, DesignTokensPanel(), EmailHistoryPanel(), fmtDate(), STATUS_COLOR, Step() (+10 more)

### Community 1 - "PhotoUploader.jsx"
Cohesion: 0.16
Nodes (18): EventsPage(), backBtn, P, SubmitHub(), P, TabPlaceholder(), P, TeamPageMobile() (+10 more)
...
Cohesion: 0.22
Nodes (14): CATEGORY_OPTIONS, emptyForm(), EventsPanel(), missingCore(), selectStyle, CATEGORY_COLOR, DEFAULT_POC, EVENT_CATEGORIES (+6 more)
...
### Community 9 - "App.jsx"
Cohesion: 0.18
Nodes (10): App(), TabRoute(), TABS, Admin(), HomeNewsletterBand(), P, OpticPromoBand(), P (+2 more)

### Community 10 - "emailRender.js"
Cohesion: 0.33
Nodes (6): Bulletin(), emptyStyle, P, TeaserRow(), viewAllBtn, toCalendarItem()

### Community 11 - "blocks.js"
Cohesion: 0.15
Nodes (19): BLOCK_TYPES, blockLabel(), BY_TYPE, makeBlock(), newId(), starterBlocks(), arrowStyle(), EmailBuilder() (+11 more)

### Community 12 - "blocks.js"
Cohesion: 0.23
Nodes (9): react, AccountsPanel(), SelfCredentialControls(), SelfAccountPanel(), ForcePasswordChange(), ReviewerPinControl(), ReviewLogin(), registerPasskey() (+1 more)
...
Cohesion: 0.12
Nodes (16): Dashboard(), ROLE_SECTIONS, S5_ALLOWED_TEAMS, SECTION_LABEL, NAV_GROUPS, Sidebar(), StatusBar(), TopBar() (+8 more)
...
Cohesion: 0.18
Nodes (14): AccountAuth(), AccountGrid(), EyeIcon(), ForcePasswordChange(), inputStyle(), PasswordForm(), LoginScreen(), BlockFields() (+6 more)
...
Cohesion: 0.43
Nodes (7): AdminBulkUpload(), drawScaled(), isRawFile(), loadImage(), RAW_EXTENSIONS, resizeForUpload(), toBlob()
...
Cohesion: 0.12
Nodes (26): BLANK_ADD_FORM, COMPANIES, ConsentSection(), GRADE_OPTIONS, LET_OPTIONS, STATUSES, BANNER_STATUSES, companyForSection() (+18 more)
...
Cohesion: 0.19
Nodes (9): downloadWinnerCard(), PhotosPanel(), VOTING_TEAMS, FILTERS, PhotoSubmissions(), TEAM_COLOR, defaultCloses(), RCATS (+1 more)
...
- **Why does `react` connect `blocks.js` to `react`, `PhotoUploader.jsx`, `PhotoUploader.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `App.jsx`, `emailRender.js`, `blocks.js`, `About.jsx`, `.oxlintrc.json`, `CadetManual.jsx`, `Footer.jsx`, `Companies.jsx`, `FaqSection.jsx`, `TabPlaceholder.jsx`, `PhotoUploader.jsx`, `Rifle.jsx`, `imageResize.js`, `AarsPanel.jsx`, `RaiderVoting.jsx`, `ui.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `EventsPage.jsx`, `PhotoLightbox.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `MonthGridCalendar.jsx`, `RaiderCarousel.jsx`?**
...
- **Why does `supabase` connect `blocks.js` to `react`, `PhotoUploader.jsx`, `PhotoUploader.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `App.jsx`, `emailRender.js`, `blocks.js`, `About.jsx`, `Footer.jsx`, `Companies.jsx`, `FaqSection.jsx`, `PhotoUploader.jsx`, `Rifle.jsx`, `imageResize.js`, `AarsPanel.jsx`, `RaiderVoting.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `EventsPage.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`?**
