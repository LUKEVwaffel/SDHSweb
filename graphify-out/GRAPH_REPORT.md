# Graph Report - Trojan Battalion Folder  (2026-07-22)

## Corpus Check
- 110 files · ~216,009 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 518 nodes · 1110 edges · 48 communities (31 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48933046`
...
### Community 0 - "react"
Cohesion: 0.08
Nodes (53): react, downloadWinnerCard(), AccountAuth(), AccountGrid(), PasswordForm(), LoginScreen(), NAV_GROUPS, AccountsPanel() (+45 more)
...
Cohesion: 0.08
Nodes (25): Dashboard(), ROLE_SECTIONS, SECTION_LABEL, Sidebar(), StatusBar(), TopBar(), AdvancedPanel(), EmailPanel() (+17 more)
...
### Community 9 - "App.jsx"
Cohesion: 0.23
Nodes (9): App(), hashToState(), stateToHash(), TABS, Admin(), Hero(), P, HomeNewsletterBand() (+1 more)

### Community 10 - "emailRender.js"
Cohesion: 0.14
Nodes (24): BlockFields(), BLOCK_TYPES, blockLabel(), BY_TYPE, makeBlock(), newId(), starterBlocks(), arrowStyle() (+16 more)
...
Cohesion: 0.53
Nodes (4): ReviewLogin(), fmtDate(), parseHashParams(), ReviewPortal()
...
Cohesion: 0.16
Nodes (23): cors, escapeHtml(), json(), preflight(), siteOrigin(), b64(), derive(), hashPin() (+15 more)
...
## Knowledge Gaps
- **133 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+128 more)
...
- **Why does `react` connect `react` to `PhotoUploader.jsx`, `Dashboard.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `App.jsx`, `emailRender.js`, `Staff.jsx`, `blocks.js`, `About.jsx`, `.oxlintrc.json`, `TopNav.jsx`, `CadetManual.jsx`, `Footer.jsx`, `Companies.jsx`, `CommandProfile.jsx`, `TabGrid.jsx`, `Pictures.jsx`, `PhotoUploader.jsx`, `RaiderVoting.jsx`, `Rifle.jsx`?**
  _High betweenness centrality (0.201) - this node is a cross-community bridge._
- **Why does `supabase` connect `react` to `PhotoUploader.jsx`, `Dashboard.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `App.jsx`, `emailRender.js`, `PhotoUploader.jsx`, `RaiderVoting.jsx`, `About.jsx`, `blocks.js`, `Staff.jsx`, `Companies.jsx`, `CommandProfile.jsx`, `Pictures.jsx`?**
