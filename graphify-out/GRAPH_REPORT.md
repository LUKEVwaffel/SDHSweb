# Graph Report - Trojan Battalion Folder  (2026-08-05)

## Corpus Check
- 192 files · ~510,623 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1342 nodes · 2253 edges · 202 communities (110 shown, 92 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c3821efc`
...
### Community 0 - "react"
Cohesion: 0.14
Nodes (15): react, AchievementCatalog(), ICON_MIME, SUBTABS, DesignTokensPanel(), HealthPanel(), STORAGE_CHECKS, TABLE_CHECKS (+7 more)
...
Cohesion: 0.15
Nodes (20): CATEGORY_OPTIONS, emptyForm(), EventsPanel(), missingCore(), selectStyle, Bulletin(), emptyStyle, P (+12 more)
...
Cohesion: 0.34
Nodes (8): BlockFields(), EmailBuilder(), Messages(), STATUS_META, Subscribers(), Label(), radius, sp
...
Cohesion: 0.17
Nodes (11): ROLE_SECTIONS, S5_ALLOWED_TEAMS, SECTION_LABEL, NAV_GROUPS, Sidebar(), StatusBar(), TopBar(), AdvancedPanel() (+3 more)
...
Cohesion: 0.13
Nodes (14): Dashboard(), AccountAuth(), AccountGrid(), EyeIcon(), ForcePasswordChange(), inputStyle(), PasswordForm(), LoginScreen() (+6 more)
...
Cohesion: 0.12
Nodes (25): BLANK_ADD_FORM, COMPANIES, ConsentSection(), GRADE_OPTIONS, LET_OPTIONS, STATUSES, BANNER_STATUSES, companyForSection() (+17 more)
...
Cohesion: 0.11
Nodes (19): @dnd-kit/sortable, @dnd-kit/utilities, expo, expo-device, dependencies, @dnd-kit/sortable, @dnd-kit/utilities, expo (+11 more)
...
Cohesion: 0.14
Nodes (15): downloadWinnerCard(), AdminBulkUpload(), PhotosPanel(), VOTING_TEAMS, FILTERS, PhotoSubmissions(), TEAM_COLOR, defaultCloses() (+7 more)
...
- **Why does `react` connect `react` to `PhotoUploader.jsx`, `PhotoUploader.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `App.jsx`, `emailRender.js`, `blocks.js`, `About.jsx`, `.oxlintrc.json`, `CadetManual.jsx`, `Footer.jsx`, `Companies.jsx`, `FaqSection.jsx`, `TabPlaceholder.jsx`, `PhotoUploader.jsx`, `Rifle.jsx`, `imageResize.js`, `AarsPanel.jsx`, `RaiderVoting.jsx`, `Companies.jsx`, `EmailHistoryPanel.jsx`, `ui.jsx`, `TeamGallery.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `EventsPage.jsx`, `PhotoLightbox.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `MonthGridCalendar.jsx`, `RaiderCarousel.jsx`?**
...
- **Why does `supabase` connect `Rifle.jsx` to `react`, `PhotoUploader.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `App.jsx`, `emailRender.js`, `blocks.js`, `About.jsx`, `Footer.jsx`, `FaqSection.jsx`, `imageResize.js`, `AarsPanel.jsx`, `RaiderVoting.jsx`, `Companies.jsx`, `EmailHistoryPanel.jsx`, `TeamGallery.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `EventsPage.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`?**
