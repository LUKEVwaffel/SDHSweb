...
## Corpus Check
- 508 files · ~785,939 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2729 nodes · 5621 edges · 330 communities (198 shown, 132 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7b3ae4f3`
...
- `useBallData()` --indirect_call--> `load()`  [INFERRED]
  src/components/balltv/BallTv.jsx → src/lib/creedProgress.js
...
Cohesion: 0.05
Nodes (56): ExistingEntry(), fieldBaseStyle, NewEntryForm(), StepRangeNotices(), addSlide(), AnnouncementSingleEditor(), cardBase, chromeBtnBase (+48 more)
...
Cohesion: 0.21
Nodes (11): PhotoGrid(), P, TabPlaceholder(), P, TeamPageMobile(), eventDateLabel(), EventRow(), SlideUpcomingEvents() (+3 more)

### Community 11 - "blocks.js"
Cohesion: 0.11
Nodes (16): downloadWinnerCard(), CompPhotoBallot(), nextFridayAt2000(), subName(), TEAM_LABEL, toLocalInput(), PhotosPanel(), VOTING_TEAMS (+8 more)
...
Cohesion: 0.20
Nodes (16): P, GameHeader(), GhostButton(), GoldButton(), ResultPanel(), buildRound(), DIFFICULTY, FillBlankGame() (+8 more)
...
Cohesion: 0.06
Nodes (32): ROLE_SECTIONS, SECTION_LABEL, NAV_GROUPS, ROLE_TAG, Sidebar(), StatusBar(), TopBar(), BallAllergyPanel() (+24 more)
...
Cohesion: 0.11
Nodes (19): AccountAuth(), AccountGrid(), EyeIcon(), PasswordForm(), ALLOWED_MIME, ROW, GUIDE_SECTIONS, TAB_INTRO (+11 more)
...
Cohesion: 0.10
Nodes (21): @dnd-kit/core, @dnd-kit/sortable, expo, expo-device, expo-file-system, dependencies, @dnd-kit/core, @dnd-kit/sortable (+13 more)
...
Cohesion: 0.15
Nodes (14): CreedHub(), GAMES, MASTERY_COLOR, MASTERY_LABEL, seededShuffle(), SequencingGame(), CREED_LINES, deepClone() (+6 more)
...
Cohesion: 0.07
Nodes (44): AccountsPanel(), AchievementCatalog(), ICON_MIME, AdvancedPanel(), SUBTABS, DesignTokensPanel(), EmailHistoryPanel(), fmtDate() (+36 more)
...
Cohesion: 0.16
Nodes (19): AdminBulkUpload(), TvPhotoEditCropModal(), FOLDERS, miniBtn(), TvPhotosPanel(), TvSpotlightPushModal(), EmptyState(), drawScaled() (+11 more)
...
Cohesion: 0.18
Nodes (12): Bulletin(), emptyStyle, P, TeaserRow(), viewAllBtn, CATEGORY_COLOR, EVENT_TEAMS, MON3 (+4 more)
...
### Community 295 - "expo-device"
Cohesion: 0.33
Nodes (6): cleanMatch(), SpeedGame(), CREED_FLAT_WORDS, CREED_FULL_TEXT, CREED_LINES_WITH_GLOBAL, CREED_WORD_COUNT

### Community 296 - "calendar.js"
Cohesion: 0.28
...
### Community 300 - "ConversationList.jsx"
Cohesion: 0.33
...
## Knowledge Gaps
- **806 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+801 more)
...
- **Why does `react` connect `ConversationList.jsx` to `react`, `PhotoUploader.jsx`, `ui.jsx`, `getDeviceId`, `BattalionCommand.jsx`, `Raiders.jsx`, `RaiderPolls.jsx`, `CheckinSurvey.jsx`, `App.jsx`, `blocks.js`, `RaiderCompetitionResults.jsx`, `About.jsx`, `BallSignupWizard.jsx`, `.oxlintrc.json`, `Messages.jsx`, `RaiderParentWelcome.jsx`, `tvRangeSchedule.js`, `Footer.jsx`, `blocks.js`, `CadetManual.jsx`, `RaiderFAQ.jsx`, `Companies.jsx`, `FaqSection.jsx`, `TabPlaceholder.jsx`, `MediaPanel.jsx`, `BallGuestVerify.jsx`, `OpticPopup.jsx`, `expo-device`, `calendar.js`, `PhotoUploader.jsx`, `RheaOnboarding.jsx`, `Rifle.jsx`, `TvRangeRaiderPracticeWidget.jsx`, `imageResize.js`, `emailAudience.js`, `TEAMS`, `react-native`, `emailRender.js`, `TvRangeSlideshowScreen.jsx`, `Rifle.jsx`, `RaiderCarousel.jsx`, `react-native`, `ConversationList.jsx`, `resizeForUpload`, `AarsPanel.jsx`, `RaiderCarousel.jsx`, `emailRender.js`, `ui.jsx`, `imageResize.js`, `TvRemotePanel.jsx`, `slideRegistry.js`, `RaiderParentWelcome.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `PhotoLightbox.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `MonthGridCalendar.jsx`, `ConversationList.jsx`, `rheaComp.js`, `RaiderCarousel.jsx`, `Rifle.jsx`, `expo`, `expo-application`, `posthog-react-native`, `TvCongratsScreen.jsx`, `FaqSection.jsx`, `Messages.jsx`, `TvRangeKiosk.jsx`, `TvPhotoCarousel.jsx`, `EventSpotlightBand.jsx`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `RaiderVoting()` connect `calendar.js` to `RaiderPolls.jsx`, `PeoplePanel.jsx`, `tvRangeSchedule.js`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `pick()` connect `PeoplePanel.jsx` to `calendar.js`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
