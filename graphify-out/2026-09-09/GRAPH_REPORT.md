# Graph Report - Trojan Battalion Folder  (2026-09-08)

## Corpus Check
- 502 files · ~778,877 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2679 nodes · 5487 edges · 332 communities (200 shown, 132 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bafbd9fe`
...
- `CompPhotoBand()` --calls--> `useCompPhotoPoll()`  [EXTRACTED]
  src/components/CompPhotoBand.jsx → src/hooks/useCompPhotoPoll.js
...
## Communities (332 total, 132 thin omitted)

### Community 0 - "react"
Cohesion: 0.11
Nodes (18): copyLink(), EventFeedbackPanel(), FUN_LABELS, BLANK_ADD_FORM, COMPANIES, ConsentSection(), FORM_INITIAL, FORMS (+10 more)
...
### Community 9 - "App.jsx"
Cohesion: 0.17
Nodes (13): RenderRuns(), storageStringToRuns(), SlideAnnouncements(), SlideAnnouncementSingle(), formatEventDate(), SlideEventSpotlight(), NoticeRow(), SlideNoticeList() (+5 more)

### Community 10 - "emailRender.js"
Cohesion: 0.09
Nodes (29): backBtn, EventsPage(), ghostBtn, loadingStyle, modeTab, modeTabActive, P, PhotoGrid() (+21 more)
...
Cohesion: 0.06
Nodes (58): build(), KEYS, SAMPLE_PARTICULARS, hits, BallCfg, ConfirmInfo, eventParticulars(), fieldTripAttachment() (+50 more)
...
Cohesion: 0.17
Nodes (13): Dashboard(), Admin(), AccountAuth(), EyeIcon(), ForcePasswordChange(), inputStyle(), PasswordForm(), LoginScreen() (+5 more)

### Community 24 - "FaqSection.jsx"
Cohesion: 0.28
Nodes (11): P, GameHeader(), GhostButton(), GoldButton(), ResultPanel(), DIFFICULTY, CREED_FLAT_WORDS, CREED_FULL_TEXT (+3 more)
...
Cohesion: 0.07
Nodes (22): ROLE_SECTIONS, SECTION_LABEL, NAV_GROUPS, ROLE_TAG, Sidebar(), StatusBar(), BetaFeaturesPanel(), CheckinPanel() (+14 more)
...
Cohesion: 0.09
Nodes (21): AccountGrid(), TopBar(), FILTERS, TEAM_COLOR, TvTerminalManager(), ROW, GUIDE_SECTIONS, TAB_INTRO (+13 more)
...
Cohesion: 0.18
Nodes (14): ALLOWED_MIME, Composer(), conversationAvatar(), ConversationList(), conversationName(), isOtherOnline(), previewText(), timeLabel() (+6 more)
...
Cohesion: 0.10
Nodes (21): @dnd-kit/core, @dnd-kit/sortable, expo, expo-application, expo-file-system, dependencies, @dnd-kit/core, @dnd-kit/sortable (+13 more)
...
Cohesion: 0.16
Nodes (14): COLORS, ConfettiBurst(), ageFromBirthdate(), CreedLeaderboardBoard(), PerfectScorePanel(), FaqSection(), P, SubmitQuestion() (+6 more)
...
Cohesion: 0.15
Nodes (11): elapsedFraction(), formatDate(), timeParts(), toMinutes(), TvClockBellPanel(), TEXT_SIZE, TvEmergencyOverlay(), TvInstrumentDivider() (+3 more)
...
Cohesion: 0.22
Nodes (14): Spinner(), Btn(), ErrorText(), Field(), Label(), mergeClass(), Radio(), TextArea() (+6 more)
...
Cohesion: 0.14
Nodes (21): TvPhotoAssignModal(), TvPhotoEditCropModal(), FOLDERS, miniBtn(), TvPhotosPanel(), TvSpotlightPushModal(), drawScaled(), isRawFile() (+13 more)

### Community 262 - "RaiderParentWelcome.jsx"
Cohesion: 0.13
Nodes (13): backBtn, Lightbox(), navArrow(), P, RaftingGallery(), P, RaftingPhotoBand(), SlidePhotoOfDay() (+5 more)
...
Cohesion: 0.22
Nodes (18): TvRangeCountdown(), TvRangeOffHoursScreen(), TvRangePeriodProgressBar(), TvRangeStaffScheduleScreen(), BELL_SCHEDULES, formatCountdownClock(), formatHHMM(), msUntilHHMM() (+10 more)

### Community 268 - "DressCodeDetails.jsx"
Cohesion: 0.27
Nodes (7): DRESS_APPROVERS, WESTON, DRESS_APPROVAL_RULES, FEMALE_AVOID, FEMALE_WEAR, MALE_AVOID, MALE_WEAR

### Community 269 - "BallSignupWizard.jsx"
Cohesion: 0.24
Nodes (10): BallSignupWizard(), emptyGuest(), fmtShort(), Shell(), STEP_HELP, STEP_LABELS, money(), para (+2 more)
...
Cohesion: 0.11
Nodes (20): DEFAULT_COLOR_GUARD_POSITIONS(), DEFAULT_HONOR_GUARD_POSITIONS(), emptyForm(), EventsPanel(), missingCore(), Bulletin(), emptyStyle, P (+12 more)
...
Cohesion: 0.29
Nodes (9): targetDate(), TvCountdownBand(), daysUntil(), eventChipLabel(), TvTopStrip(), useBattalionCreed(), todayNy(), useTvUpcomingEvents() (+1 more)

### Community 276 - "StepRangeSchedule.jsx"
Cohesion: 0.28
Nodes (14): EventDetailCard(), formatDateRange(), UpcomingEventsList(), DayEventDetail(), categoryColor(), formatEventTime(), formatEventTimeRange(), teamLabel() (+6 more)
...
Cohesion: 0.32
Nodes (4): BallGuestVerify(), FadeUp(), Skeleton(), DressCodeDetails()
...
Cohesion: 0.24
Nodes (10): linkBtn, money(), p, StepDocumentation(), guestVerify(), invokeError(), lookupCadet(), resolveRosterCadet() (+2 more)
...
Cohesion: 0.21
Nodes (15): ExistingEntry(), NewEntryForm(), AnnouncementSingleEditor(), domToRuns(), mergeRuns(), runsToPlainText(), runsToStorageString(), sameFormat() (+7 more)
...
Cohesion: 0.24
Nodes (10): TvKiosk(), TvPreviewBadge(), TvRangeKiosk(), TvRefreshNotice(), getPreviewAt(), getPreviewOffsetMs(), useNowTicker(), useStayAwake() (+2 more)
...
Cohesion: 0.67
Nodes (3): buildRound(), FillBlankGame(), pickBlankIndices()

### Community 326 - "RecallGame"
Cohesion: 0.67
Nodes (3): cleanMatch(), hintFor(), RecallGame()

### Community 328 - "TvKiosk.jsx"
Cohesion: 0.29
Nodes (8): TvRangeCompanyWelcomeScreen(), TvRangeLunchScreen(), TvRangePeriodEndingScreen(), TvRangePlanningScreen(), TvRangeScreenBase(), TvRangeT2Screen(), TvRangeClock(), renderTemplate()

### Community 329 - "StepRangeNotices.jsx"
Cohesion: 0.31
Nodes (7): fieldBaseStyle, StepRangeNotices(), TvRangeRotationLayout(), useTvNotices(), createTvNotice(), deleteTvNotice(), updateTvNotice()

### Community 330 - "SlideUniformCountdown.jsx"
Cohesion: 0.36
Nodes (5): SlideUniformCountdown(), targetDate(), uniformDateLabel(), todayNy(), useTvNextUniformDay()

## Knowledge Gaps
- **790 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+785 more)
...
- **Why does `react` connect `ConversationList.jsx` to `react`, `PhotoUploader.jsx`, `ui.jsx`, `getDeviceId`, `BattalionCommand.jsx`, `Raiders.jsx`, `RaiderParentWelcome.jsx`, `CheckinSurvey.jsx`, `emailRender.js`, `blocks.js`, `RaiderCompetitionResults.jsx`, `About.jsx`, `BallSignupWizard.jsx`, `.oxlintrc.json`, `Messages.jsx`, `RaiderParentWelcome.jsx`, `CadetManual.jsx`, `Footer.jsx`, `Companies.jsx`, `ConversationList.jsx`, `RaiderFAQ.jsx`, `FaqSection.jsx`, `TabPlaceholder.jsx`, `BallGuestVerify.jsx`, `OpticPopup.jsx`, `PhotoUploader.jsx`, `EventSpotlightBand.jsx`, `Rifle.jsx`, `RaiderParentWelcome.jsx`, `imageResize.js`, `App.jsx`, `emailAudience.js`, `TEAMS`, `react-native`, `RaiderPolls.jsx`, `StepDocumentation.jsx`, `TvRangeSlideshowScreen.jsx`, `TvHistoryPanel.jsx`, `Rifle.jsx`, `react-native`, `RaiderParentWelcome.jsx`, `RaiderTvPanel.jsx`, `resizeForUpload`, `blocks.js`, `TvHistoryPanel.jsx`, `AarsPanel.jsx`, `RaiderCarousel.jsx`, `emailRender.js`, `ui.jsx`, `imageResize.js`, `TvRemotePanel.jsx`, `StepRangeNotices.jsx`, `SlideUniformCountdown.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `PhotoLightbox.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `MonthGridCalendar.jsx`, `ConversationList.jsx`, `rheaComp.js`, `RaiderCarousel.jsx`, `Rifle.jsx`, `expo`, `expo-application`, `posthog-react-native`, `TvCongratsScreen.jsx`, `FaqSection.jsx`, `TvRangeKiosk.jsx`, `TvPhotoCarousel.jsx`, `EventSpotlightBand.jsx`?**
  _High betweenness centrality (0.200) - this node is a cross-community bridge._
- **Why does `RaiderVoting()` connect `RaiderPolls.jsx` to `emailRender.js`, `RaiderPolls.jsx`, `PeoplePanel.jsx`?**
