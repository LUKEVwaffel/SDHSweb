# Graph Report - Trojan Battalion Folder  (2026-07-26)

## Corpus Check
- 139 files · ~447,436 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 592 nodes · 1272 edges · 62 communities (38 shown, 24 thin omitted)
...
### Community 0 - "react"
Cohesion: 0.06
Nodes (62): react, downloadWinnerCard(), AccountAuth(), AccountGrid(), PasswordForm(), AccountsPanel(), AchievementCatalog(), ICON_MIME (+54 more)
...
### Community 9 - "App.jsx"
Cohesion: 0.31
Nodes (7): App(), hashToState(), stateToHash(), TABS, HomeNewsletterBand(), P, Staff()
...
Cohesion: 0.67
Nodes (3): fmtDate(), parseHashParams(), ReviewPortal()

### Community 13 - "About.jsx"
Cohesion: 0.13
Nodes (10): About(), CORE_VALUES, FAQS, P, TODO: awaiting finalized Q&A content., TEAMS, FaqSection(), P (+2 more)
...
## Knowledge Gaps
- **147 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+142 more)
...
- **Why does `react` connect `react` to `PhotoUploader.jsx`, `Dashboard.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `App.jsx`, `PhotoUploader.jsx`, `About.jsx`, `.oxlintrc.json`, `TopNav.jsx`, `CadetManual.jsx`, `Footer.jsx`, `Companies.jsx`, `CommandProfile.jsx`, `TabGrid.jsx`, `Pictures.jsx`?**
  _High betweenness centrality (0.196) - this node is a cross-community bridge._
- **Why does `supabase` connect `react` to `PhotoUploader.jsx`, `Dashboard.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `PhotoUploader.jsx`, `App.jsx`, `About.jsx`, `Companies.jsx`, `CommandProfile.jsx`, `Pictures.jsx`?**
