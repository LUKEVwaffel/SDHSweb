...
## Corpus Check
- 360 files · ~649,411 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1991 nodes · 3977 edges · 260 communities (148 shown, 112 thin omitted)
...
- `About()` --references--> `sb`  [EXTRACTED]
  src/components/About.jsx → scripts/mark-raiders-team.mjs
...
## Communities (260 total, 112 thin omitted)

### Community 0 - "react"
Cohesion: 0.10
Nodes (31): AccountsPanel(), AchievementCatalog(), ICON_MIME, AdvancedPanel(), SUBTABS, DesignTokensPanel(), EmailHistoryPanel(), fmtDate() (+23 more)
...
Cohesion: 0.14
Nodes (19): addSlide(), cardBase, chromeBtnBase, FONT_STYLEABLE_TYPES, moveSlide(), removeSlide(), rowFieldStyle, SlideExtraControls() (+11 more)
...
Cohesion: 0.15
Nodes (15): Dashboard(), ForcePasswordChange(), inputStyle(), SelfCredentialControls(), SelfAccountPanel(), ForcePasswordChange(), ReviewerPinControl(), ReviewLogin() (+7 more)
...
### Community 9 - "App.jsx"
Cohesion: 0.18
Nodes (10): App(), TabRoute(), TABS, HomeNewsletterBand(), P, OpticPromoBand(), P, RaiderParentWelcome() (+2 more)
...
Cohesion: 0.15
Nodes (22): BlockFields(), BLOCK_TYPES, blockLabel(), BY_TYPE, makeBlock(), newId(), starterBlocks(), arrowStyle() (+14 more)

### Community 12 - "blocks.js"
Cohesion: 0.08
Nodes (29): EmergencyPushPanel(), BASE_TABS, DEFAULT_RANGE_CONFIG, draftFromSettings(), RANGE_LAYOUT_TAB, RANGE_NOTICE_TABS, RANGE_TAB, rangeConfigFromRow() (+21 more)
...
Cohesion: 0.10
Nodes (19): ROLE_SECTIONS, SECTION_LABEL, NAV_GROUPS, Sidebar(), StatusBar(), TopBar(), BetaFeaturesPanel(), EmailPanel() (+11 more)
...
Cohesion: 0.10
Nodes (19): AccountAuth(), AccountGrid(), EyeIcon(), PasswordForm(), LoginScreen(), TEXT_SIZES, fs, P (+11 more)
...
### Community 72 - "ui.jsx"
Cohesion: 0.11
Nodes (13): FAQS, P, RaiderFAQ(), CAT_LABEL, CommanderCard(), EventCalendar(), fmtDate(), initials() (+5 more)
...
Cohesion: 0.11
Nodes (20): BLANK_ADD_FORM, COMPANIES, FORM_INITIAL, FORMS, GRADE_OPTIONS, LET_OPTIONS, CONSENT_META, FORM_STATUS_COLS (+12 more)
...
Cohesion: 0.17
Nodes (10): downloadWinnerCard(), PhotosPanel(), VOTING_TEAMS, FILTERS, PhotoSubmissions(), TEAM_COLOR, defaultCloses(), RCATS (+2 more)
...
Cohesion: 0.06
Nodes (55): allRosterNames, alreadyOn, cadetKeys, dryRun, matchedRosterNames, toInsert, unmatched, P (+47 more)
...
Cohesion: 0.31
Nodes (9): ConsentSection(), STATUSES, documentHtml(), escapeHtml(), openConsentStatusPdf(), progressHtml(), rowHtml(), byLastName() (+1 more)

### Community 197 - "emailRender.js"
Cohesion: 0.24
Nodes (7): SlidePhotoOfDay(), TEXT_SIZE, TvEmergencyOverlay(), TvPhotoCarousel(), TvStandardLayout(), useTvCarouselPhotos(), TV_PHOTOS
...
Cohesion: 0.22
Nodes (10): TvRangeRotationLayout(), targetDate(), TvCountdownBand(), daysUntil(), eventChipLabel(), TvTopStrip(), useBattalionCreed(), todayNy() (+2 more)
...
Cohesion: 0.19
Nodes (16): sb, Admin(), ElementRegistry(), WidgetLibrary(), TvPhotoEditCropModal(), FOLDERS, miniBtn(), TvPhotosPanel() (+8 more)
...
Cohesion: 0.33
Nodes (6): CheckinSurvey(), P, labelFor(), QUESTIONS, hasSeenCheckin(), markCheckinSeen()
...
Cohesion: 0.21
Nodes (12): TvKiosk(), TvPreviewBadge(), TvRangeKiosk(), TvRefreshNotice(), isStale(), TvShoutoutsPanel(), getPreviewAt(), getPreviewOffsetMs() (+4 more)
...
Cohesion: 0.50
Nodes (4): TvPhotoAssignModal(), FOLDER_LABELS, FOLDER_ORDER, resolveTvPhotoCaption()
...
## Knowledge Gaps
- **656 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+651 more)
...
- **Why does `react` connect `MediaPanel.jsx` to `react`, `PhotoUploader.jsx`, `EventsPanel.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `App.jsx`, `emailRender.js`, `blocks.js`, `blocks.js`, `About.jsx`, `.oxlintrc.json`, `CadetManual.jsx`, `Footer.jsx`, `Companies.jsx`, `FaqSection.jsx`, `TabPlaceholder.jsx`, `PhotoUploader.jsx`, `Rifle.jsx`, `imageResize.js`, `expo-application`, `expo-file-system`, `AarsPanel.jsx`, `RaiderCarousel.jsx`, `emailRender.js`, `ui.jsx`, `imageResize.js`, `TvRemotePanel.jsx`, `PeoplePanel.jsx`, `index.jsx`, `StepRangeNotices.jsx`, `TabGrid.jsx`, `RaiderPolls.jsx`, `PhotoLightbox.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `MonthGridCalendar.jsx`, `ConversationList.jsx`, `ReviewPortal.jsx`, `RangeGridCountdown.jsx`, `Companies.jsx`, `RaiderCarousel.jsx`, `TvRangeRaiderPracticeWidget.jsx`, `FaqSection.jsx`, `CadetManual.jsx`, `Companies.jsx`, `EventSpotlightBand.jsx`?**
...
- **Why does `P` connect `Rifle.jsx` to `react`, `PhotoUploader.jsx`, `EventsPanel.jsx`, `Raiders.jsx`, `emailRender.js`, `blocks.js`, `blocks.js`, `PhotoUploader.jsx`, `expo-file-system`, `AarsPanel.jsx`, `emailRender.js`, `imageResize.js`, `TvRemotePanel.jsx`, `PeoplePanel.jsx`, `index.jsx`, `StepRangeNotices.jsx`, `TabGrid.jsx`, `RaiderPolls.jsx`, `OverviewPanel.jsx`, `ConversationList.jsx`, `RangeGridCountdown.jsx`, `TvRangeRaiderPracticeWidget.jsx`, `MediaPanel.jsx`, `Companies.jsx`?**
