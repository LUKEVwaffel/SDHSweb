# Graph Report - Trojan Battalion Folder  (2026-09-02)

## Corpus Check
- 464 files · ~748,309 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2477 nodes · 5087 edges · 306 communities (180 shown, 126 thin omitted)
...
2. `react` - 169 edges
3. `P` - 118 edges
4. `supabase` - 107 edges
5. `sp` - 101 edges
6. `fs` - 89 edges
7. `radius` - 50 edges
8. `Btn()` - 49 edges
9. `serviceClient()` - 40 edges
10. `Label()` - 33 edges
...
## Communities (306 total, 126 thin omitted)

### Community 0 - "react"
Cohesion: 0.08
Nodes (44): react, AccountsPanel(), AchievementCatalog(), ICON_MIME, AdvancedPanel(), SUBTABS, DesignTokensPanel(), EmailHistoryPanel() (+36 more)
...
Cohesion: 0.18
Nodes (13): FocalPointPicker(), TvPhotoEditCropModal(), FOLDERS, miniBtn(), TvPhotosPanel(), TvSpotlightPushModal(), Modal(), deleteTvPhoto() (+5 more)

### Community 4 - "ui.jsx"
Cohesion: 0.05
Nodes (60): ExistingEntry(), fieldBaseStyle, NewEntryForm(), StepRangeNotices(), addSlide(), AnnouncementSingleEditor(), cardBase, chromeBtnBase (+52 more)
...
### Community 9 - "App.jsx"
Cohesion: 0.24
Nodes (11): TvRangeCompanyWelcomeScreen(), TvRangeCountdown(), TvRangeLunchScreen(), TvRangeOffHoursScreen(), TvRangePeriodEndingScreen(), TvRangePlanningScreen(), TvRangeScreenBase(), TvRangeStaffScheduleScreen() (+3 more)
...
Cohesion: 0.11
Nodes (16): downloadWinnerCard(), AdminBulkUpload(), CompPhotoBallot(), nextFridayAt2000(), subName(), TEAM_LABEL, toLocalInput(), VOTING_TEAMS (+8 more)
...
Cohesion: 0.08
Nodes (37): hits, ConfirmInfo, sendCadetConfirmation(), FIELD_LABEL, Position, cors, escapeHtml(), json() (+29 more)
...
Cohesion: 0.09
Nodes (21): Dashboard(), ROLE_SECTIONS, SECTION_LABEL, NAV_GROUPS, ROLE_TAG, Sidebar(), StatusBar(), TopBar() (+13 more)
...
Cohesion: 0.12
Nodes (29): arrowBtn(), miniBtn(), RaiderTvPanel(), bigBtn(), CodeScreen(), ControlScreen(), ctrlBtn, loadSaved() (+21 more)
...
Cohesion: 0.11
Nodes (12): isStale(), TvBottomWidget(), targetDate(), TvCountdownBand(), TvCustomMessagePanel(), TEXT_SIZE, TvEmergencyOverlay(), TvInstrumentDivider() (+4 more)

### Community 93 - "ConversationList.jsx"
Cohesion: 0.31
Nodes (6): BallOpsPortal(), ForcePasswordChange(), ReviewerPinControl(), ReviewLogin(), fmtDate(), ReviewPortal()
...
Cohesion: 0.14
Nodes (11): App(), TABS, BallAttirePortal(), BallDressLogin(), BallDressPortal(), ALL_CHAPTERS, CadetManual(), P (+3 more)
...
Cohesion: 0.08
Nodes (36): BallGuestVerify(), BallLanding(), fmtDate(), fmtShort(), money(), FactsSkeleton(), FadeUp(), Skeleton() (+28 more)
...
Cohesion: 0.22
Nodes (10): Admin(), ForcePasswordChange(), inputStyle(), conversationAvatar(), ConversationList(), conversationName(), isOtherOnline(), previewText() (+2 more)

### Community 271 - "ball_signup.sql"
Cohesion: 0.36
Nodes (6): public.ball_config, public.ball_dress_reserve_pin_attempt(), public.ball_dress_staff, public.ball_guests, public.ball_signups, public.is_ball_dress()
...
Cohesion: 0.20
Nodes (10): TvHistoryPanel(), TvKiosk(), TvPreviewBadge(), TvRangeKiosk(), getPreviewAt(), getPreviewOffsetMs(), useNowTicker(), useTvDailySettings() (+2 more)
...
Cohesion: 0.32
Nodes (14): TvRangePeriodProgressBar(), formatCountdownClock(), formatHHMM(), msUntilHHMM(), nextBell(), nyMillisOfDay(), nyMinutesOfDay(), toMinutes() (+6 more)
...
Cohesion: 0.20
Nodes (9): TvPhotoAssignModal(), SlidePhotoOfDay(), TvPhotoCarousel(), TvStandardLayout(), useTvCarouselPhotos(), FOLDER_LABELS, FOLDER_ORDER, resolveTvPhotoCaption() (+1 more)

### Community 307 - "ball_finalize.sql"
Cohesion: 0.38
Nodes (5): public.ball_config, public.ball_dress_staff, public.ball_signups, public.is_ball_attire(), public.is_ball_dress()

### Community 309 - "pwa.js"
Cohesion: 0.29
Nodes (9): LukePwaRoute(), headTags(), installPwaHooks(), installRheaPwaHooks(), isStandalone(), registerPwa(), Rhea(), RheaLocked() (+1 more)

### Community 310 - "FillBlankGame.jsx"
Cohesion: 0.60
Nodes (4): buildRound(), DIFFICULTY, FillBlankGame(), pickBlankIndices()

## Knowledge Gaps
- **731 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+726 more)
...
- **Why does `react` connect `react` to `PhotoUploader.jsx`, `ui.jsx`, `BattalionCommand.jsx`, `Raiders.jsx`, `RaiderCompetitionResults.jsx`, `RaiderParentWelcome.jsx`, `CheckinSurvey.jsx`, `emailRender.js`, `RecallGame`, `blocks.js`, `About.jsx`, `tvRangeSchedule.js`, `.oxlintrc.json`, `Messages.jsx`, `RaiderParentWelcome.jsx`, `eventsPdfPrint.js`, `Footer.jsx`, `blocks.js`, `CadetManual.jsx`, `RaiderFAQ.jsx`, `Companies.jsx`, `FaqSection.jsx`, `ConversationList.jsx`, `TabPlaceholder.jsx`, `EventFeedbackPanel.jsx`, `getDeviceId`, `Companies.jsx`, `OpticPopup.jsx`, `BallPanel.jsx`, `PhotoUploader.jsx`, `emailAudience.js`, `Rifle.jsx`, `imageResize.js`, `RaiderParentWelcome.jsx`, `RaiderCarousel.jsx`, `TvRangeSlideshowScreen.jsx`, `FillBlankGame.jsx`, `TvHistoryPanel.jsx`, `RaiderVoting.jsx`, `PhotoUploader.jsx`, `AarsPanel.jsx`, `RaiderCarousel.jsx`, `emailRender.js`, `ui.jsx`, `imageResize.js`, `TvRemotePanel.jsx`, `PeoplePanel.jsx`, `RaiderPolls.jsx`, `PhotoLightbox.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `MonthGridCalendar.jsx`, `ConversationList.jsx`, `rheaComp.js`, `RaiderCarousel.jsx`, `Rifle.jsx`, `expo`, `TvCongratsScreen.jsx`, `FaqSection.jsx`, `TvRangeKiosk.jsx`, `TvPhotoCarousel.jsx`, `EventSpotlightBand.jsx`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `supabase` connect `react` to `PhotoUploader.jsx`, `ui.jsx`, `BattalionCommand.jsx`, `getDeviceId`, `CheckinSurvey.jsx`, `emailRender.js`, `RecallGame`, `blocks.js`, `About.jsx`, `tvRangeSchedule.js`, `eventsPdfPrint.js`, `Messages.jsx`, `blocks.js`, `RaiderParentWelcome.jsx`, `Footer.jsx`, `Companies.jsx`, `FaqSection.jsx`, `TabPlaceholder.jsx`, `Companies.jsx`, `BallPanel.jsx`, `emailAudience.js`, `Rifle.jsx`, `imageResize.js`, `RaiderParentWelcome.jsx`, `RaiderCarousel.jsx`, `TvRangeSlideshowScreen.jsx`, `TvHistoryPanel.jsx`, `RaiderVoting.jsx`, `PhotoUploader.jsx`, `AarsPanel.jsx`, `RaiderCarousel.jsx`, `emailRender.js`, `ui.jsx`, `TvRemotePanel.jsx`, `RaiderPolls.jsx`, `MediaPanel.jsx`, `OverviewPanel.jsx`, `ConversationList.jsx`, `rheaComp.js`, `Rifle.jsx`, `FaqSection.jsx`, `TvRangeKiosk.jsx`, `TvPhotoCarousel.jsx`, `EventSpotlightBand.jsx`?**
...
- **Should `react` be split into smaller, more focused modules?**
  _Cohesion score 0.08098223615464994 - nodes in this community are weakly interconnected._
